...
public class Main {
	public static void main(String[] a) {
		...
		for (Integer j = 2; j <= (10 * diasPorAnio); j++) {
			...
			//Utilizo constructor para los dias diferentes al primero, aqui le envio las posiciones iniciales con el dia correspondiente, y ademas el dia buscado actual
		...
		System.out.println("Períodos de sequia:");
		System.out.println(periodosSequia);

		System.out.println("Períodos de lluvia:");
		System.out.println(periodosLluvia);

		System.out.println("Día de mayor lluvia");
		System.out.println(pronosticos.get(mayorLluviaDia).getDia());

		System.out.println("Períodos de condiciones Óptimas de presión y temperatura");
		System.out.println(periodosOptimo);
